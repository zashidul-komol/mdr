    ...
    <div class="col-sm-12">
        ...
        <div class="panel">
            <div class="panel-content">
                {{ Form::model($distributors,array('route' => array('distributors.update',$distributors->id),'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                   ...
                   <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            ...
                            {!! $errors->first('distributorName', '<p class="text-danger">:message</p>' ) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('region_id') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                             {{Form::select('region_id',[''=>'--Please Select Distributor--']+$regions->toArray(),null,array('class' => 'form-control'))}}
                    ...
                    <div class="form-group{{ $errors->has('areaname') ? ' has-error' : '' }}">
                        {{Form::label('Area Name:',null,array('class' => 'control-label col-sm-2 require'))}}
                        <div class="col-md-6">
