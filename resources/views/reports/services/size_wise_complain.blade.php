...
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            ...
            <li><a href="{{route('servicereports.sizeWiseComplain')}}">Size Wise Complain</a></li>
        </ul>
    </div>
</div>
<div class="row animated fadeInRight">
	 <div class="col-sm-12">
		<div class="panel">
			...
			{{ Form::open(['url'=>route('servicereports.sizeWiseComplain'),'method'=>'post', 'id'=>'brand-wise-df-status', 'class'=>'form-horizontal']) }}
        ...
        @if(isset($is_download))
		  @if(count($reportData))
            ...
            @endif
            <h4 class="section-subtitle"><b>Size Wise Complain Report</b></h4>
            @include('reports.services.size_wise_complain_report')
        @endif
