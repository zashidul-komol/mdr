...
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            ...
            <li><a href="{{route('servicereports.dateWiseComplain')}}">Date Wise Complain</a></li>
        </ul>
    </div>
</div>
<div class="row animated fadeInRight">
	 <div class="col-sm-12">
		<div class="panel">
			...
			{{ Form::open(['url'=>route('servicereports.dateWiseComplain'),'method'=>'post', 'id'=>'brand-wise-df-status', 'class'=>'form-horizontal']) }}
            {{ Form::hidden('is_download', 0, array('id' => 'is_download') ) }}
				<div class="row">
					<div class="col-md-12">
                        ...
                        <!--Depot Code-->
                        <div class="form-group">
                            {{Form::label('Sizes:',null,array('class' => 'control-label col-sm-2'))}}

                            <div class="col-md-8">
                                {{Form::select('sizeIds[]',$sizes->toArray(), $sizeIds,array('class' => 'form-control','id'=>'dfcode-select2', 'multiple'=>true))}}
                            </div>
                        </div>
        ...
        @endif
            ...
            <h4 class="section-subtitle"><b>Date Wise Complain Report</b></h4>
            @include('reports.services.date_wise_complain_report')
