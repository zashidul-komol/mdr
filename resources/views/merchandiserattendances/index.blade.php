...
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            ...
            <li><a>Merchandiser Application List</a></li>
        </ul>
    </div>
</div>
<div class="tabs">
    <ul class="nav nav-tabs">
        <li class="{{'active'}}"><a href="{{ route('merchandisers.index') }}">New</a></li>
                 ...
                 <div class="table-responsive">
                    <table id="datatable" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                      ...
                      <tr>
                        ...
                        <th width="25%">Office Location</th>
...
<script>
        function showModal(id,){
            ...
            $.ajax({
                type: 'Get',
                url:"{{ route('ajax.items.getItemDetailsBySeraialMerchandiser') }}",
                data:{id:id}
