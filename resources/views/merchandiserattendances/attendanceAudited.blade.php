...
<div class="tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="{{'active'}}"><a href="{{ route('merchandiserattendances.attendanceAudited') }}">Audited</a></li>
                 ...
                 <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$data->date or ''}}</td>
                        <td>                               
                            {!!  Html::decode(link_to_route('mdrattendances.attendanceViewCheck', '<span aria-hidden="true" class="fa fa-eye fa-x"></span>', array($data->id)))!!}
                            {!! Html::decode(link_to_route('mdrattendances.approveAttendanceDownload','<span aria-hidden="true" class="fa fa-download fa-x"></span>' , [$data->id],['title'=>'Download'])) !!}
