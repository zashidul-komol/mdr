...
<div class="content-header">
    <div class="text-center">
        <ul class="breadcrumbs">
            <li><i class="fa fa-home" aria-hidden="true"></i><a href="#"><h4 class="section-subtitle"><b>Merchandiser Monthly Attendance Report Download</b></h4></a></li>
        </ul>
    </div>
</div>
    <div class="panel">
            ...
            <div class="panel-content">
               {{ Form::model(request()->old(),array('route' => array('merchandiserattendances.downloadAttendanceReport'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                <div class="table-responsive">
                      ...
                      <div class="form-group">
                            <div align="center" class="col-md-8 col-md-offset-2">
                                <button type="submit" class="btn btn-primary" value="1" id="attendance" name="Attendance">
                                    Salary Sheet
                                </button>
