...
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Attendance Submitted List</a></li>
            <li><a>Attendance Submitted List</a></li>
        </ul>
    </div>
</div>
<div class="tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="{{'active'}}"><a href="{{ route('merchandiserattendances.attendanceSubmitted') }}">Submitted</a></li>
        <li><a href="{{ route('merchandiserattendances.attendanceProcessing') }}">Processing</a></li>
