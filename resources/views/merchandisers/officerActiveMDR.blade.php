...
@section('title', 'Officer Active MDR List')
@section('content')
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Officer's Active MDR List</a></li>
            <li><a>Officer's Active MDR List</a></li>
...
<div class="tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="{{'active'}}"><a href="{{ route('requisitions.officerActiveMDR') }}">Officer's MDR</a></li>
    </ul>
</div>
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 class="section-subtitle">
            <b>Officer's Active MDR List</b>
        </h4>
