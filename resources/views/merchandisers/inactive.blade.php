...
@section('title', 'Inactive MDR List')
@section('content')
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Inactive MDR List</a></li>
            <li><a>Inactive MDR List</a></li>
...
<div class="tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="{{'active'}}"><a href="{{ route('requisitions.inactive') }}">Inactive MDR</a></li>
                 ...
                 <div class="table-responsive">
                    <table id="datatable" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                      ...
                      <tr>
                        ...
                        <th width="5%">Inactive Date</th>
                        <th width="14%">Reason</th>
                        <th width="14%">Action</th>
                        <th width="14%">Resign Letter</th>
                      </tr>
                    </thead>
                    <tbody>
                        @php ($i=1)
