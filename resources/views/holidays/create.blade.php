...
@section('title', 'Add Holiday Setup')
@section('content')
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Monthly Holiday</a></li>
            <li><a>Add</a></li>
        </ul>
    </div>
</div>
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Add Holiday</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('holidays.index','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
            <div class="panel-content">
                {{ Form::model(request()->old(),array('route' => array('holidays.store'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                    ...
                    <div class="from-group">
                        ...
                        @if(request()->old('details'))
                            <stockdetails :brands="{{ $Months }}" :details="{{ collect(request()->old('details')) }}"/>
                        @else
                            <stockdetails :brands="{{ $Months }}" :details="[]"/>
                        @endif
