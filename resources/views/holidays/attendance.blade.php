                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                            <div align="center" class="col-md-8 col-md-offset-2">
                                ...
                                <button type="submit" class="btn btn-primary" value="3" id="attendance" name="Attendance">
                                    TA/DA Bill-PDF
                                </button>
                                <button type="submit" class="btn btn-primary" value="4" id="attendance" name="Attendance">
                                    TA/DA Bill-Excel
                                </button>
                                <button type="submit" class="btn btn-primary" value="5" id="attendance" name="Attendance">
