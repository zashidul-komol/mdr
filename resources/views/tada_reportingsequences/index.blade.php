...
@section('title', 'TA/DA Reporting Sequence Lists')
@section('content')
...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
       <h4 class="section-subtitle"><b>TA/DA Reporting Sequence Lists</b></h4>
        <span class="pull-right">
            
            {!! Html::decode(link_to_route('tada_reportingsequences.create','<i class="fa fa-plus"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
        ...
        @include('common_pages.common_modal_reporting',['modalTitle'=>'TA/DA Reporting Sequence'])
...
<script>
        function showModal(id,){
            ...
            $.ajax({
                type: 'Get',
                url:"{{ route('ajax.tadareporting.getTaDaReportingSequence') }}",
                data:{id:id}
