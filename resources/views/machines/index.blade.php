    ...
    <div class="col-sm-12">
       <h4 class="section-subtitle"><b>Machine Lists</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('machines.download','<i class="fa fa-download" aria-hidden="true"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}

            {!! Html::decode(link_to_route('machines.create','<i class="fa fa-plus"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
