<div class="col-md-6">
    <h4 class="section-subtitle"><b>Merchandiser Application Status</b> At A Glance</h4>
    <span class="pull-right">
            <a class="btn btn-danger btn-left-side" href="{{ route('merchandisers.create',[]) }}">Application form for Merchandiser</a>
    </span>
    <div class="panel">
           <div class="row dash-box-height SixBox">
                ...
                <div class="col-md-4">
                    <a href="{{ route('requisitions.activelist',[1]) }}">
                        <div class="dash-box-heightIn">
                            <h4 class="subtitle">Active Merchandiser</h4>
                            <div class="row">
                                <div class="col-xs-6">
                ...
                <div class="col-md-4">
                    <a href="{{ route('requisitions.inactive',[1]) }}">
                        <div class="dash-box-heightIn">
                            <h4 class="subtitle">Inactive Merchandiser</h4>
                            <div class="row">
                                <div class="col-xs-6">
                ...
                <div class="col-md-4">
                    <a href="{{ route('mdrattendances.attendanceList',[1]) }}">
                        <div class="dash-box-heightIn">
                            <h4 class="subtitle">Attendance List</h4>
                            <div class="row">
                                <div class="col-xs-6">
                ...
                <div class="col-md-4">
                    <a href="{{ route('requisitions.officerActiveMDR',[1]) }}">
                        <div class="dash-box-heightIn">
                            <h4 class="subtitle">{{$OfficerName}}'s Active Merchandiser</h4>
                            <div class="row">
                                <div class="col-xs-6">
