...
<div class="content-header">
    <div class="text-center">
        <ul class="breadcrumbs">
            <li><i class="fa fa-home" aria-hidden="true"></i><a href="#"><h4 class="section-subtitle"><b>Active MDR Monthly Attendance</b></h4></a></li>
        </ul>
    </div>
</div>
    <div class="panel">
...
function getAmount(id, effectivedate, basic_salary){
    ...
    //alert(govt_holiday);
    let d = new Date();
    let specificNumberOfFriday = specificDays('Friday',MONTHNAMES[d.getMonth()],d.getFullYear(),effectivedate);
    ...
    if(current_month_days >0){
        ...
        if(current_month_days >13){
            ...
            $('#gross_salary'+id).val(parseFloat((((basic_salary_id/month_days)*CurPayableDays) + ((500/month_days)*CurPayableDays) + (120)*working_days + (120)*(working_days-meeting_days) + ((basic_salary_id/30)*(weekly_holiday + govt_holiday)) + others_ta_bill + (((basic_salary_id/30)*2)*eid_duty) )).toFixed(0));
...
function specificDays(dayName, monthName, year, effectivedate='') {
 ...
 function getWorkingDay(id, effectivedate){
    ...
    let d = new Date();
    let specificNumberOfFriday_new = specificDays('Friday',MONTHNAMES[d.getMonth()],d.getFullYear(),effectivedate);
