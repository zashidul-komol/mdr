...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 align="center" class="section-subtitle"><b>Application for Market Development Representative </b></h4>
        ...
        <div class="panel">
            <div class="panel-content">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        <label for="inputName" class="col-sm-2 require">Distributor :</label>
                        <div class="col-md-5">
                            {{Form::select('distributor_id',[''=>'--Please Select Distributor--']+$distributorsUser->toArray(),null,array('class' => 'form-control select2'))}}
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputName" class="col-sm-2 require">Market Activity Score :</label>
                                                        
                    </div>
                    <div class="form-group">
                        <label for="inputName" class="col-sm-2 "></label>
                        <label for="inputName" class="col-sm-2 require">Dress Up: </label>
                        <div class="col-md-1">
                            {{Form::text('dressUp',null,array('class' => 'form-control'))}}
                             {!! $errors->first('dressUp', '<p class="text-danger">:message</p>' ) !!}
                        </div>(Out of 5)
                    </div>
                    <div class="form-group">
                        <label for="inputName" class="col-sm-2 "></label>
                        <label for="inputName" class="col-sm-2 require">Physical Strength: </label>
                        <div class="col-md-1">
                            {{Form::text('physicalStrenth',null,array('class' => 'form-control'))}}
                             {!! $errors->first('physicalStrenth', '<p class="text-danger">:message</p>' ) !!}
                        </div>(Out of 5)
                    </div>
                    <div class="form-group">
                        <label for="inputName" class="col-sm-2 "></label>
                        <label for="inputName" class="col-sm-2 require">PDF Merchandising: </label>
                        <div class="col-md-1">
                            {{Form::text('pdfMerchendising',null,array('class' => 'form-control'))}}
                             {!! $errors->first('pdfMerchendising', '<p class="text-danger">:message</p>' ) !!}
                        </div>(Out of 5)
                    </div>
                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                        <label for="inputName" class="col-sm-2 require">Rating :</label>
                        <div class="col-md-5">
                            {{Form::select('rating',config('myconfig.rating'),null,array('class' => 'form-control'))}}
                            {!! $errors->first('rating', '<p class="text-danger">:message</p>' ) !!}
                        </div>
                    </div>
                    <div class="form-group">
                      <label for="inputName" class="col-sm-2 require">Effective Date</label>
                        <div class="col-md-5">
                            <div class="input-group">
                              <span class="input-group-addon x-primary"><i class="fa fa-calendar"></i></span>
                                {{Form::text('effectivedate',null,array('class' => 'form-control datepicker3' , 'readonly' => 'true'))}}
                            </div>
                        </div> 
