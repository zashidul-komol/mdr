...
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Requisition List</a></li>
            <li><a>Requisition List</a></li>
        </ul>
    </div>
</div>
<div class="tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="{{'active'}}"><a href="{{ route('requisitions.hold') }}">Hold</a></li>
        <li><a href="{{ route('requisitions.cancelled') }}">Cancelled</a></li>
        <li><a href="{{ route('requisitions.approved') }}">Approved</a></li>
        <li><a href="{{ route('requisitions.inactive') }}">Inactive</a></li>
...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        ...
        @include('common_pages.common_modal',['modalTitle'=>'Requisition Details', 'modalSize'=>'modal-lg'])
...
<script>
        function showModal(id,){
            ...
            $.ajax({
                type: 'Get',
                url:"{{ route('ajax.items.getRequisitionHold') }}",
                data:{id:id}
