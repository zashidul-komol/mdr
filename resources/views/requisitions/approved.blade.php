...
<div class="tabs">
    <ul class="nav nav-tabs">
        ...
        <li class="{{'active'}}"><a href="{{ route('requisitions.approved') }}">Approved</a></li>
...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        ...
        <span class="pull-right">
            {!! Html::decode(link_to_route('requisitions.ApprovedMDRdownload','<i class="fa fa-download" aria-hidden="true"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
                 ...
                 <div class="table-responsive">
                    <table id="datatable" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                      ...
                      <tr>
                        ...
                        <th width="15%">Applicant Education</th>
                        <th width="15%">Salary</th>
                        <th width="15%">Rocket Number</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$data->mdrInformation->basic_salary  ??  ''}}</td>
                        <td>{{$data->mdrInformation->applicant_mobile  ??  ''}}</td>
                        ...
                        <td>                               
                            ...
                            {!! Html::decode(link_to_route('requisitions.mdragreementDownload','<span aria-hidden="true" class="fa fa-table fa-x"></span>' , [$data->id],['title'=>'MDR Agreement Download'])) !!}                         
                        </td>
                      </tr>
                        @php ($i=$i+1)
                        @endforeach
