    ...
    export default {
        ...
        methods: {
            ...
            reqedit() {
                    ...
                    for(let i=0; this.requisitiondetails.length>i; i++){
                        let items = this.requisitiondetails[i];
                        let forwhoom = this.requiredfor[0];
                    
                        this.inputs.push({
                        product_id: items.product_id,
                        particular_id: '',
                        requsition_quantity: items.requsition_quantity,
                        measurement_id: items.measurement_id,
                        unitprice: items.unitprice,
                        totalprice: items.totalprice,
                        PresentStock: items.present_stock,
