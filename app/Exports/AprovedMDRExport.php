...
class AprovedMDRExport implements FromQuery, WithMapping, WithHeadings, ShouldAutoSize, WithEvents {
    use Exportable;
    ...
    public function query() {
        ...
        ->select(   'mdr_informations.id',
            ...
            ->where('mdr_informations.status','!=', 'pending')
            ...
            ->orderBy('mdr_informations.application_id', 'ASC');
